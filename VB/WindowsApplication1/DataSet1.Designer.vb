...
Namespace WindowsApplication1
	...
	Public Partial Class DataSet1
		...
		Public Partial Class DataTable1DataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddDataTable1Row(ByVal StringProperty As String, ByVal CurrentDate As System.DateTime, ByVal IntProperty As Integer) As DataTable1Row
				Dim rowDataTable1Row As DataTable1Row = (CType(Me.NewRow(), DataTable1Row))
				Dim columnValuesArray As Object() = New Object() { StringProperty, CurrentDate, IntProperty}
